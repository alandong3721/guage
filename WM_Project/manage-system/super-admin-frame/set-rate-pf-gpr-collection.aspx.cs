...
{
    public partial class set_rate_pf_gpr_collection : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    {
                        pageNow = 1;
                        rate_count = new SetPFGPRCRateForUserDAO().getUserRateCount();
                        rate_page_count = new SetPFGPRCRateForUserDAO().getPageCount(rate_count, pageSize);
        ...
        protected void btn_set_pf_rate_Click(object sender, EventArgs e)
        {
            ...
            int flag = new SetPFGPRCRateForUserDAO().setRateForUser(username, ratetype, staffname);
        ...
        protected void user_has_discount_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName.Equals("delete"))
            {
                ...
                if (new SetPFGPRCRateForUserDAO().deleteUserRate(name))
                {
                    alert("删除成功！！");
                    rate_count--;
        ...
        public DataTable createUserRateTable(int pageNow, int pageSize)
        {
            ...
            DataTable staffTable = new SetPFGPRCRateForUserDAO().getUserRate(pageNow, pageSize);
