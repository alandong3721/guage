...
{
    public partial class add_rate_type_ems : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    string sql = "select " + type + " from tb_rate_ems";
        ...
        protected void btn_ems_rate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < freight_array.Length; i++)
            {
                ...
                string up_str = "update tb_rate_ems set " + ratetype + "=" + money + " where id=" + (i + 1);
            ...
            string sql = "select " + ratetype + " from tb_rate_ems";
            DataTable table = new DBOperateCommon().excuteQuery(sql);
            current_rate.Clear();
