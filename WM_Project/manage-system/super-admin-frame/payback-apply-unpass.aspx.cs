...
{
    public partial class payback_apply_unpass : System.Web.UI.Page
    {
                ...
                else
                {
                    ...
                    if (page == null)
                    {
                        ...
                        if (source.Rows.Count > 0)
                        {
                            ...
                            record_count = new PayBackApplyDAO().getUnPassPayBackApplyCount();
        ...
        private DataTable createTable(int pageNow, int pageSize)
        {
            ...
            DataTable temp = new PayBackApplyDAO().getUnPassPayBackApplyTable(pageNow, pageSize);
