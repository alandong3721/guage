...
{
    public partial class add_rate_type_pf_ipe_depot : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    string sql = "select " + type + " from tb_rate_pf_ipe_depot";
        ...
        protected void btn_pf_rate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < freight_array.Length; i++)
            {
                ...
                string up_str = "update tb_rate_pf_ipe_depot set " + ratetype + "=" + money + " where id=" + (i + 1);
            ...
            string sql = "select " + ratetype + " from tb_rate_pf_ipe_depot";
            DataTable table = new DBOperateCommon().excuteQuery(sql);
            current_rate.Clear();
        ...
        private void initRateArray()
        {
            ...
            string sql = "select * from tb_rate_pf_ipe_depot";
            DataTable table = new DBOperateCommon().excuteQuery(sql);
