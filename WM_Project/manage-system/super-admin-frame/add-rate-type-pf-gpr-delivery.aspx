<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-rate-type-pf-gpr-delivery.aspx.cs" Inherits="WM_Project.manage_system.super_admin_frame.add_rate_type_pf_gpr_delivery" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" style="text-align: center">
                    <asp:Button ID="btn_pf_rate" runat="Server" Text="设置 PF-GPR-D 邮费类型" CssClass="btn btn-info" OnClientClick="return isFreightRight()"
