<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="set-rate-pf-ipe-collection.aspx.cs" Inherits="WM_Project.manage_system.super_admin_frame.set_rate_pf_ipe_collection" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" style="margin-top: 10px; height: 40px; clear: both;text-align:center">
                    <asp:Button ID="btn_set_pf_rate" Text="设置 PF-IPE-C 邮费" runat="Server" OnClientClick="return isNameNULL()" 
            ...
            <div class="panel-body">
                <div id="user_has_discount_div" runat="Server">
                    ...
                    <div style="text-align: right">
                        ...
                        <%if (pageNow != 1)
                          {%>
                        <a href="set-rate-pf-ipe-collection.aspx?pageNow=1">首页</a>&nbsp;&nbsp;&nbsp; <a
                            href="set-rate-pf-ipe-collection.aspx?pageNow=<%=pageNow-1 %>">上一页</a>&nbsp;&nbsp;&nbsp;
                        <%} %>
                        <% if (pageNow != rate_page_count)
                           {
                        %><a href="set-rate-pf-ipe-collection.aspx?pageNow=<%=pageNow+1 %>">下一页</a>&nbsp;&nbsp;&nbsp;
                        <a href="set-rate-pf-ipe-collection.aspx?pageNow=<%=rate_page_count %>">尾页</a>&nbsp;&nbsp;&nbsp;
                        <%} %>
                        <% } %>
                    </div>
