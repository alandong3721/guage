...
{
    public partial class set_rate_pf_ipe_pol : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    {
                        pageNow = 1;
                        rate_count = new SetPFIPEPolRateForUserDAO().getUserRateCount();
                        rate_page_count = new SetPFIPEPolRateForUserDAO().getPageCount(rate_count, pageSize);
        ...
        protected void btn_set_pf_rate_Click(object sender, EventArgs e)
        {
            ...
            int flag = new SetPFIPEPolRateForUserDAO().setRateForUser(username, ratetype, staffname);
        ...
        protected void user_has_discount_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName.Equals("delete"))
            {
                ...
                if (new SetPFIPEPolRateForUserDAO().deleteUserRate(name))
                {
                    alert("删除成功！！");
                    rate_count--;
        ...
        public DataTable createUserRateTable(int pageNow, int pageSize)
        {
            ...
            DataTable staffTable = new SetPFIPEPolRateForUserDAO().getUserRate(pageNow, pageSize);
