...
{
    public partial class set_rate_pf_ipe_depot : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    {
                        pageNow = 1;
                        rate_count = new SetPFIPEDepotRateForUserDAO().getUserRateCount();
                        rate_page_count = new SetPFIPEDepotRateForUserDAO().getPageCount(rate_count, pageSize);
        ...
        protected void btn_set_pf_rate_Click(object sender, EventArgs e)
        {
            ...
            int flag = new SetPFIPEDepotRateForUserDAO().setRateForUser(username, ratetype, staffname);
        ...
        protected void user_has_discount_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName.Equals("delete"))
            {
                ...
                if (new SetPFIPEDepotRateForUserDAO().deleteUserRate(name))
                {
                    alert("删除成功！！");
                    rate_count--;
        ...
        public DataTable createUserRateTable(int pageNow, int pageSize)
        {
            ...
            DataTable staffTable = new SetPFIPEDepotRateForUserDAO().getUserRate(pageNow, pageSize);
