<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/back-stage/admin.Master" AutoEventWireup="true" CodeBehind="super-admin-order-management.aspx.cs" Inherits="WM_Project.manage_system.super_admin_order_management" %>
                ...
                <div class="panel panel-primary" style=" padding-left: 0px">
                    ...
                    <div class="panel-body" style="padding-left: 0px; padding-right: 0px">
                        <div id="firstpane" style="width: 100%">
                            <p class="menu_head">国际订单管理</p>
                            <div id="order_management" class="menu_body" runat="server" style="display: none">
                                <a href="frame/check-interface-order-by-time.aspx" target="content" style=" text-decoration:none">按时间查看界面订单</a>
                                <a href="frame/check-excel-order-by-time.aspx" target="content" style=" text-decoration:none">按时间查看Excel订单</a>
                            ...
                            <div id="local_order_management" class="menu_body" runat="server" style="display: none">
                                ...
                                <a href="frame/check-local-order-by-name.aspx" target="content" style=" text-decoration:none">按会员名查看</a>
                            </div>
