...
{
    public partial class check_excel_order_by_time : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            txt_from.Text = start_time = Session["start"].ToString();
                            txt_to.Text = end_time = Session["end"].ToString();
                            pageNow = Convert.ToInt32(page);
