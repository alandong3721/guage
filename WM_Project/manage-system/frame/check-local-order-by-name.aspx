<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="check-local-order-by-name.aspx.cs" Inherits="WM_Project.manage_system.frame.check_local_order_by_name" %>
                    ...
                    <table class="table table-striped " id="package" width="100%">
                        ...
                        <tr>
                            <td colspan="7" style="text-align: right">
                                ...
                                <%if (pageNow != 1)
                                  {%>
                                <a href="check-order-by-name.aspx?pageNow=1">首页</a>&nbsp;&nbsp;&nbsp; <a href="check-order-by-name.aspx?pageNow=<%=pageNow-1 %>">
                                    上一页</a>&nbsp;&nbsp;&nbsp;
                                <%} %>
                                <% if (pageNow != page_count)
                                   {
                                %><a href="check-order-by-name.aspx?pageNow=<%=pageNow+1 %>">下一页</a>&nbsp;&nbsp;&nbsp;
                                <a href="check-order-by-name.aspx?pageNow=<%=page_count %>">尾页</a>&nbsp;&nbsp;&nbsp;
                                <%} %>
                                <%
                                  } %>
                            </td>
