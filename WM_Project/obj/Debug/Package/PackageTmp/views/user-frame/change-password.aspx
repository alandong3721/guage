<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="change-password.aspx.cs"
    Inherits="WM_Project.views.user_frame.change_password" %>
    ...
    <div class="panel panel-primary" style="width: 780px">
        ...
        <div class="panel-body">
            <div class="form-group" style="height: 40px; clear: both">
                <div style="width: 200px; float: left; text-align:right; padding-right: 20px;">
                ...
                <div style="width: 40px; color: #FF0000; float: left; padding-top: 10px; padding-left: 10px">
                    *</div>
            </div>
            <div class="form-group" style="height: 40px; clear: both">
                <div style="width: 200px; float: left; padding-right: 20px;text-align:right">
                    <label class="control-label" style="text-align: right; padding-top: 5px">
                        New Password</label>
                </div>
                <div style="width: 460px; float: left">
                    <input type="password" name="newpwd" id="newpwd" class="form-control" /></div>
                <div style="color: #FF0000; width: 40px; float: left; padding-top: 10px; padding-left: 10px">
                    *</div>
            </div>
            <div class="form-group" style="height: 40px; clear: both">
                <div style="width: 200px; float: left; padding-right: 20px;text-align:right">
            ...
            <div class="form-group" style="padding-top: 10px; text-align: center; clear: both">
                <asp:Button ID="btn_change_pwd" CssClass="btn btn-info" Text="修改密码" runat="server"
                    OnClick="btn_change_pwd_Click" OnClientClick="return isnull()" /></div>
        </div>
