<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/reception-stage/batch.Master"
    AutoEventWireup="true" CodeBehind="local-order-process.aspx.cs" Inherits="WM_Project.views.user_frame.local_order_process" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="center" runat="server">
    <div class="panel panel-primary" id="part_one" runat="Server" style="width: 80%; margin: 0 auto; margin-bottom: 30px">
            ...
            <asp:DataList ID="local_postway" runat="Server" 
                ...
                <ItemTemplate>
                    <tr style="height:80px;">
                        <td style="width:200px;text-align:left"><%#DataBinder.Eval(Container.DataItem,"image") %></td>
    ...
    <div class="panel panel-primary" style="width: 80%; margin: 0 auto; margin-bottom: 30px"
        ...
        <div class="panel-body">
            ...
            <div class="form-group" style="text-align: center; margin-top: 20px">
                <asp:Button CssClass="btn btn-info gotocart" Text="去购物车结算" ID="btn_goto_cart" runat="Server"
