<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/reception-stage/home.Master" AutoEventWireup="true"
    CodeBehind="custom-red-packet.aspx.cs" Inherits="WM_Project.views.custom_red_packet" %>
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <p style="text-align: center">
                        <img src="../image/how-to-get-red-packet.png" alt="" /></p>
                    ...
                    <p style="text-align: center;">
                        <img src="../image/how-to-receive-red-packet.png" alt="" /></p>
                    ...
                    <p style="text-indent: 2em; line-height: 25px;">
                        ...
                        <p style="text-align:center"><img src="../image/how-to-use-red-packet.png" alt="" /></p>
