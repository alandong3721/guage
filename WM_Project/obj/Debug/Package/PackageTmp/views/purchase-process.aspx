                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" style="height: 26px;">
                                <label class="col-md-3 control-label" style="text-align: right;">
                                    取件时间</label>
                                <div class="col-md-8">
                                    <input type="text" name="collection_time" style="padding-top:0px;padding-bottom:0px;height:25px" class="form-control" onclick="new Calendar().show(this)" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr style="text-align: left">
                            <td colspan="5" style="width: 100%; text-align: left">
                                <label class="col-md-6 control-label">
                                    包裹<%=i + 1%>:#<%=good.Count %>*<%=good.Weight %>*<%=good.Length %>*<%=good.Width %>*<%=good.Height %></label><span
                                        class="col-md-6" style="text-align: right"><input type="button" class="btn-danger btn-xs"
                                            style="height: 30px; width: 200px" value="将第一箱信息复制到其他箱" /></span>
                            </td>
                        </tr>
                        <%
                            ...
                            { %>
                        <tr>
                            <td class="panel-title" style="padding-left: 20px; width: 12%; text-align: left">
                                <label>
                                    第<%= j+1%>箱</label>
                            </td>
                            ...
                            <td style="width: 20%; padding-left: 0px; text-align: left">
                                <input type="text" name="package_value" class="form-control" style="padding-top:0px;padding-bottom:0px;height:25px" />
                            </td>
                        </tr>
                        <%} %>
                    </table>
