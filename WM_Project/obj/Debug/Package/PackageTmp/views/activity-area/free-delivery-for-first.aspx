<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/reception-stage/home.Master" AutoEventWireup="true" CodeBehind="free-delivery-for-first.aspx.cs" Inherits="WM_Project.views.activity_area.free_delivery_for_first" %>
            ...
            <div class="panel-body">
                <div>
                    <p style="text-align: center; margin-top: 30px">
                        <img src="../../image/image/free-for-first-package.jpg" alt="" /></p>
                ...
                <div class="form-group" style="height: 130px;">
                    <div class="col-md-6" style="text-align: center">
                        <a href="#">
                            <img src="../../image/image/free-package-from-uk.jpg" alt="" /></a></div>
                    <div class="col-md-6" style="text-align: center">
                        <a href="#">
                            <img src="../../image/image/free-package-from-china.jpg" alt="" /></a></div>
                </div>
