<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/reception-stage/batch.Master" AutoEventWireup="true"
    CodeBehind="my-order-detail-info.aspx.cs" Inherits="WM_Project.views.my_order_detail_info" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".update").click(function () {
                ...
                var email = address.find(".emailsend");
                ...
                var email2 = address.find(".emailreceive");

                if (contact2.val() == "" || company2.val() == "" || line2.val() == "" || city2.val() == "" || postcode2.val() == "" || country2.val() == "" || phone2.val() == "" || email2.val() == "") {
                    alert("收件地址中带 * 号的不能为空！！");
                    return false;
...
<asp:Content ID="Content2" ContentPlaceHolderID="center" runat="server">
    <div class="panel panel-primary">
        ...
        <div class="panel-body" runat="Server">
                ...
                <div style="border: 2px solid #DADADA; width: 49%; margin-top: 20px; float: left"
                    ...
                    <div class="form-group" style="height: 40px; clear: both">
                        <label class="col-md-3 control-label" style="padding-top: 10px; padding-left: 40px">
                            邮箱</label>
                        <div class="col-md-8">
                            <asp:TextBox runat="Server" class="form-control emailsend" ID="txt_send_addr_email"></asp:TextBox>
                        </div>
                        <div class="col-md-1" style="color: Red; padding-top: 10px">
                            *</div>
                    </div>
                ...
                <div style="border: 2px solid #DADADA; width: 49%; float: right; margin-top: 20px"
                    ...
                    <div class="form-group" style="height: 40px; clear: both">
                        <label class="col-md-3 control-label" style="padding-top: 10px; padding-left: 40px">
                            邮箱</label>
                        <div class="col-md-8">
                            <asp:TextBox runat="Server" class="form-control emailreceive" ID="txt_receive_addr_email"></asp:TextBox>
                        </div>
                        <div class="col-md-1" style="color: Red; padding-top: 10px">
                            *</div>
                    </div>
            ...
            <div class="form-group" id="has_not_addr_id" runat="Server" visible="false" style="height: 200px">
                <div>
                    <input type="hidden" name="order_number" value="<%=order_number %>" /></div>
                <div class="col-md-6">
                    <p style="padding-left: 60px; font-weight: 600">
                        发件地址：</p>
                    <div style="margin-left: 60px; margin-right: 30px">
                        <asp:TextBox ID="txt_area_send_address" runat="server" CssClass="txt_area_send_address"
                            TextMode="MultiLine" Width="100%" Height="160px" Style="resize: none"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6">
                    <p style="font-weight: 600; margin-left: 30px">
                        收件地址：</p>
                    <div style="margin-left: 30px; margin-right: 60px">
                        <asp:TextBox ID="txt_area_receive_address" runat="server" CssClass="txt_area_receive_address"
                            TextMode="MultiLine" Width="100%" Height="160px" Style="resize: none"></asp:TextBox>
                    </div>
                </div>
            </div>
                ...
                <div style="border: 2px solid #DADADA; margin-top: 20px; margin-left: 1%; width: 32%;
                    ...
                    <table class="table table-striped ">
                        ...
                        <tr style="height: 25px">
                            ...
                            <td style="width: 55%">
                                <input type="text" name="value" class="form-control value" value="<%=(package.Package_value) %>" />
                            </td>
                            <td style="width: 10%; color: Red">
                                *
                            </td>
            ...
            <div class="form-group" style="clear: both; height: 30px; padding-top: 20px;" id="unpay_operation"
                ...
                <div class="col-md-6" style="text-align: right">
                    <asp:Button ID="btn_update" runat="Server" Text="跟&nbsp;&nbsp;新" CssClass="btn btn-info update"
                        Width="120px" OnClick="btn_update_Click" />
                </div>
            </div>
            <div class="form-group" style="clear: both; height: 30px; padding-top: 20px;" id="pay_operation"
                runat="Server" visible="false">
                <div class="col-md-6" style="text-align: left">
                    <asp:Button ID="btn_back_order_management" runat="Server" Text="返回订单管理" CssClass="btn btn-info"
                        OnClick="btn_back_order_management_Click" />
                </div>
                <div class="col-md-6" style="text-align: right">
                    <asp:Button ID="btn_book_order" runat="Server" Text="继续下单" CssClass="btn btn-info continue"
                        Width="120px" OnClick="btn_book_order_Click" />
                </div>
            </div>
        </div>
    </div>
