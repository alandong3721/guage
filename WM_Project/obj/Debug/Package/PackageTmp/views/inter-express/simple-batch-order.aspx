    ...
    <div class="row" id="page_one" runat="Server">
        <div class="panel panel-primary">
            ...
            <div class="panel-footer" style="color:#107DE6">
                <h6>* 请注意 Quantity 表示该订单中的包裹数,每一个包裹的重量不要超过 <font color="red">30kg </font>，每个订单中的包裹必须是同一发件、收件地址</h6>
                <h6>* 若使用Parcelforce economy 服务方式每一订单中包裹数不能超过 <font color="red">1</font>，若使用 Parcelforce priority auto 服务方式每个订单中包裹数不能超过 <font color="red">3</font>, 否则无法正常完成下单。</h6>
            </div>
        </div>
    </div>
                ...
                <div class="form-group">
                    <table class="table table-striped ">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%; text-align: left; padding-top: 15px">
                                #<%=order.Count %>*<%=order.Weight %>*<%=order.Length %>*<%=order.Width %>*<%=order.Height %>
                            </td>
