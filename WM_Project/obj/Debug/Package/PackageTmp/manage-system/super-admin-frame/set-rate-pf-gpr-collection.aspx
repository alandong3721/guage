<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="set-rate-pf-gpr-collection.aspx.cs" Inherits="WM_Project.manage_system.super_admin_frame.set_rate_pf_gpr_collection" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" style="margin-top: 10px; height: 40px; clear: both">
                    ...
                    <div style="width: 500px; float: left;">
                        <select class="form-control" name="pfrate">
                            <option>rate1</option>
                            <option>rate2</option>
                            <option>rate3</option>
                            <option>rate4</option>
                ...
                <div class="form-group" style="margin-top: 10px; height: 40px; clear: both;text-align:center">
                    <asp:Button ID="btn_set_pf_rate" Text="设置 PF-GPR-Collection 邮费" runat="Server" OnClientClick="return isNameNULL()" 
                        CssClass="btn btn-info" onclick="btn_set_pf_rate_Click" />
                </div>
            </div>
            ...
            <div class="panel-body">
                <div id="user_has_discount_div" runat="Server">
                    <asp:DataList ID="user_has_discount" runat="Server" OnItemCommand="user_has_discount_ItemCommand">
                        <HeaderTemplate>
                            <table style="width: 660px; margin: 0 auto; border: 2px solid #DADADA">
                                <tr style="height: 2px">
                    ...
                    <div style="text-align: right">
                        ...
                        <%if (pageNow != 1)
                          {%>
                        <a href="set-rate-pf-gpr-collection.aspx?pageNow=1">首页</a>&nbsp;&nbsp;&nbsp; <a
                            href="set-rate-pf-gpr-collection.aspx?pageNow=<%=pageNow-1 %>">上一页</a>&nbsp;&nbsp;&nbsp;
                        <%} %>
                        <% if (pageNow != rate_page_count)
                           {
                        %><a href="set-rate-pf-gpr-collection.aspx?pageNow=<%=pageNow+1 %>">下一页</a>&nbsp;&nbsp;&nbsp;
                        <a href="set-rate-pf-gpr-collection.aspx?pageNow=<%=rate_page_count %>">尾页</a>&nbsp;&nbsp;&nbsp;
                        <%} %>
                        <% } %>
                    </div>
