<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-rate-type-pf-ipe-trailer.aspx.cs" Inherits="WM_Project.manage_system.super_admin_frame.add_rate_type_pf_ipe_trailer" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" style="text-align: center">
                    <asp:Button ID="btn_pf_rate" runat="Server" Text="设置 PF-IPE-T 邮费类型" CssClass="btn btn-info" OnClientClick="return isFreightRight()"
                        Width="240px" OnClick="btn_pf_rate_Click" />
                </div>
            </div>
            <div class="panel-footer" style="color:#FF0000; font-weight:600">
                <p>*&nbsp;设置邮费时请注意，邮费必须从 rate1 最高不能更改， 否则将导致计算的邮费有误！！！</p>
            </div>
        </div>
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    PF-IPE-Trailer 各类型的邮费信息如下</h3>
            </div>
            <div class="panel-body">
                <div class="form-group">
