<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-rate-type-pf-ipe-collection.aspx.cs" Inherits="WM_Project.manage_system.super_admin_frame.add_rate_type_pf_ipe_collection" %>
...
<body>
    ...
    <div style="width: 700px;">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    设置 PF-IPE-Collection 各类型的邮费</h3>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group" style="text-align: center">
                    <asp:Button ID="btn_pf_rate" runat="Server" Text="设置 PF-IPE-C 邮费类型" CssClass="btn btn-info" OnClientClick="return isFreightRight()"
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    PF-IPE-Collection 各类型的邮费信息如下</h3>
            </div>
            <div class="panel-body">
                <div class="form-group">
