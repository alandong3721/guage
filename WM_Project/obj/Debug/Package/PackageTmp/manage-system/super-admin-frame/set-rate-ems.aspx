<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="set-rate-ems.aspx.cs" Inherits="WM_Project.manage_system.super_admin_frame.set_rate_ems" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" style="margin-top: 10px; height: 40px; clear: both">
                    ...
                    <div style="width: 500px; float: left;">
                        <select class="form-control" name="emsrate">
                            <option>rate1</option>
                            <option>rate2</option>
                            <option>rate3</option>
                            <option>rate4</option>
                ...
                <div class="form-group" style="margin-top: 10px; height: 40px; clear: both; text-align: center">
                    <asp:Button ID="btn_set_ems_rate" Text="设置 EMS Rate" runat="Server" CssClass="btn btn-info"
                        OnClientClick="return isNameNULL()" OnClick="btn_set_ems_rate_Click" />
                </div>
            </div>
            <div class="panel-footer" style="color: #FF0000">
                *注意用户名必须是用户的登陆名，否则设置无效,如果不是第一次为用户设置邮费类型，则是跟新用户的旧的邮费类型
            </div>
        </div>
            ...
            <div class="panel-body">
                <div id="user_has_discount_div" runat="Server">
                    ...
                    <div style="text-align: right">
                        ...
                        <%if (pageNow != 1)
                          {%>
                        <a href="set-rate-ems.aspx?pageNow=1">首页</a>&nbsp;&nbsp;&nbsp; <a href="set-rate-ems.aspx?pageNow=<%=pageNow-1 %>">
                            上一页</a>&nbsp;&nbsp;&nbsp;
                        <%} %>
                        <% if (pageNow != rate_page_count)
                           {
                        %><a href="set-rate-ems.aspx?pageNow=<%=pageNow+1 %>">下一页</a>&nbsp;&nbsp;&nbsp;
                        <a href="set-rate-ems.aspx?pageNow=<%=rate_page_count %>">尾页</a>&nbsp;&nbsp;&nbsp;
                        <%} %>
                        <% } %>
                    </div>
