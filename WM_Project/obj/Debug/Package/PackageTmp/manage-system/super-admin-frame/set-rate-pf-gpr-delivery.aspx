<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="set-rate-pf-gpr-delivery.aspx.cs" Inherits="WM_Project.manage_system.super_admin_frame.set_rate_pf_gpr_delivery" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" style="margin-top: 10px; height: 40px; clear: both;text-align:center">
                    <asp:Button ID="btn_set_pf_rate" Text="设置 PF-GPR-Delivery" runat="Server" OnClientClick="return isNameNULL()" 
            ...
            <div class="panel-body">
                <div id="user_has_discount_div" runat="Server">
                    ...
                    <div style="text-align: right">
                        ...
                        <%if (pageNow != 1)
                          {%>
                        <a href="set-rate-pf-gpr-delivery.aspx?pageNow=1">首页</a>&nbsp;&nbsp;&nbsp; <a
                            href="set-rate-pf-gpr-delivery.aspx?pageNow=<%=pageNow-1 %>">上一页</a>&nbsp;&nbsp;&nbsp;
                        <%} %>
                        <% if (pageNow != rate_page_count)
                           {
                        %><a href="set-rate-pf-gpr-delivery.aspx?pageNow=<%=pageNow+1 %>">下一页</a>&nbsp;&nbsp;&nbsp;
                        <a href="set-rate-pf-gpr-delivery.aspx?pageNow=<%=rate_page_count %>">尾页</a>&nbsp;&nbsp;&nbsp;
                        <%} %>
                        <% } %>
                    </div>
