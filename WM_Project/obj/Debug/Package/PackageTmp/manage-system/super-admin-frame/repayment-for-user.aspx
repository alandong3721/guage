<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repayment-for-user.aspx.cs"
    Inherits="WM_Project.manage_system.super_admin_frame.repayment_for_user" %>
    ...
    <div class=" panel panel-primary" style="width: 700px; ">
        ...
        <div class="panel-body">
            ...
            <div class="form-group" style="clear:both;height:40px">
                ...
                <div style="width:500px;float:left">
                    <input type="text" class="form-control note_repay" name="note_repay" /></div>
            ...
            <div class="form-group" style="text-align:center;height:40px">
                    <asp:Button ID="btn_user_repay_right" runat="server" CssClass="btn btn-info repay"
                        Text="确认还款" OnClick="btn_user_repay_right_Click" Width="120px" />
            </div>
            <div style="height: 10px">
                &nbsp;</div>
        </div>
        <div class="panel-footer" style="color: #FF0000">
            *用户必须在欠森林运输的钱的前提下，才能为用户还款，如果用户只欠森林运输 £2000，而该用户向森林运输转了£3000，那么管理员应该先为该用户还款£2000，再为用户充值£1000，再又为用户还款£1000
            <br />
