<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-rate-type-ems.aspx.cs"
    Inherits="WM_Project.manage_system.super_admin_frame.add_rate_type_ems" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" style="text-align: center">
                    <asp:Button ID="btn_ems_rate" runat="Server" Text="设置EMS邮费类型" CssClass="btn btn-info"
                        OnClientClick="return isFreightRight()" Width="240px" OnClick="btn_ems_rate_Click" />
                </div>
            </div>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <table border="1" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <th style="text-align: center; width: 63px;">
                                重量(kg)
                            </th>
