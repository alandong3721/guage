<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="check-local-order-by-number.aspx.cs" Inherits="WM_Project.manage_system.frame.check_local_order_by_number" %>
     ...
     <div class="panel panel-primary" style="width: 800px; font-size: 13px">
                    ...
                    <table class="table table-striped " id="package" width="100%">
                        ...
                        <tr>
                            <td colspan="8" style="text-align: right">
                                ...
                                <%if (pageNow != 1)
                                  {%>
                                <a href="check-order-by-number.aspx?pageNow=1">首页</a>&nbsp;&nbsp;&nbsp; <a href="check-order-by-number.aspx?pageNow=<%=pageNow-1 %>">
                                    上一页</a>&nbsp;&nbsp;&nbsp;
                                <%} %>
                                <% if (pageNow != page_count)
                                   {
                                %><a href="check-order-by-number.aspx?pageNow=<%=pageNow+1 %>">下一页</a>&nbsp;&nbsp;&nbsp;
                                <a href="check-order-by-number.aspx?pageNow=<%=page_count %>">尾页</a>&nbsp;&nbsp;&nbsp;
                                <%} %>
                                <%
                                  } %>
                            </td>
        ...
        <div class=" panel-footer">
            <p style="color: #FF0000; font-weight: 600; font-size: 16px;">
                * 输入的订单号可以是“AU”开头的，也可以是 “WA”，“WM”，“WP”开头的</p>
        </div>
    </div>
    </form>
</body>
