<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="check-excel-order-by-time.aspx.cs"
    Inherits="WM_Project.manage_system.frame.check_excel_order_by_time" %>
                    ...
                    <table class="table table-striped " id="package" width="100%">
                        ...
                        <tr>
                            <td colspan="8" style="text-align: right">
                                ...
                                <%if (pageNow != 1)
                                  {%>
                                <a href="check-excel-order-by-time.aspx?pageNow=1">首页</a>&nbsp;&nbsp;&nbsp; <a href="check-excel-order-by-time.aspx?pageNow=<%=pageNow-1 %>">
                                    上一页</a>&nbsp;&nbsp;&nbsp;
                                <%} %>
                                <% if (pageNow != page_count)
                                   {
                                %><a href="check-excel-order-by-time.aspx?pageNow=<%=pageNow+1 %>">下一页</a>&nbsp;&nbsp;&nbsp;
                                <a href="check-excel-order-by-time.aspx?pageNow=<%=page_count %>">尾页</a>&nbsp;&nbsp;&nbsp;
                                <%} %>
                                <%
                                  } %>
                            </td>
