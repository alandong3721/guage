<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/back-stage/staff.Master" AutoEventWireup="true" CodeBehind="staff-account-management.aspx.cs" Inherits="WM_Project.manage_system.staff_account_management" %>
    ...
    <div id="magagerbody" style="margin-left:-15px;margin-right:-15px">
                    ...
                    <div class="panel-body" style="padding-left: 0px; padding-right: 0px">
                        <div id="firstpane" style="width: 100%">
                            ...
                            <div id="staff_management" class="menu_body" runat="server" style="display: none">
                                <a href="staff-frame/change-person-info.aspx" target="content" style=" text-decoration:none" >修改个人信息</a> 
                                <a href="staff-frame/change-password.aspx" target="content" style=" text-decoration:none">修改密码</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="contentright" style="display: inline;">
            <iframe name="content" id="content" style="margin-left: 20px; margin-top: 0px;" width="700px;"
                src="staff-frame/change-person-info.aspx" frameborder="no" border="0" marginwidth="0"
