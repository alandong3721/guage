<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/back-stage/admin.Master" AutoEventWireup="true" CodeBehind="super-admin-account.aspx.cs" Inherits="WM_Project.manage_system.super_admin_account" %>
     ...
     <div id="magagerbody">
                ...
                <div class="panel panel-primary" style=" padding-left: 0px">
                    ...
                    <div class="panel-body" style="padding-left: 0px; padding-right: 0px">
                        <div id="firstpane" style="width: 100%">
                            <p class="menu_head"><a href="super-admin-frame/admin-change-password.aspx" target="content"  style=" text-decoration:none;color:#525252;">修改密码</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="contentright" style="display: inline;">
            <iframe name="content" id="content" style="margin-left: 20px; margin-top: 0px;" width="700px;"
                src="super-admin-frame/admin-change-password.aspx" frameborder="no" border="0" marginwidth="0"
