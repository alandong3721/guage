<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/back-stage/admin.Master" AutoEventWireup="true" CodeBehind="super-admin-staff-management.aspx.cs" Inherits="WM_Project.manage_system.super_admin_staff_management" %>
    ...
    <div id="magagerbody">
                    ...
                    <div class="panel-body" style="padding-left: 0px; padding-right: 0px">
                        <div id="firstpane" style="width: 100%">
                            ...
                            <div id="staff_management" class="menu_body" runat="server" style="display: none">
                                <a href="super-admin-frame/add-staff.aspx" target="content" style=" text-decoration:none" >添加员工</a> 
                                <a href="super-admin-frame/check-staff.aspx" target="content" style=" text-decoration:none">查看现有员工</a>
                            </div>
        ...
        <div id="contentright" style="display: inline;">
            <iframe name="content" id="content" style="margin-left: 20px; margin-top: 0px;" width="700px;"
                src="super-admin-frame/add-staff.aspx" frameborder="no" border="0" marginwidth="0"
