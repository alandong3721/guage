    ...
    public partial class order_pay : System.Web.UI.Page
    {
        ...
        protected void btn_Submit(object sender, EventArgs e)
        {
            ...
            if(paymethod=="wm-account")
            {
                ...
                if (new MyAccountDAO().userPayUseMyAccount(username, amount))
                {
                    Response.Redirect("pay-success.aspx?username=" + name + "&code=" + success_code + "&paymethod=my-account");
                }
                else
                {
                    Response.Redirect("repeat-pay.aspx?username=" + name + "&code=" + success_code);
                }
