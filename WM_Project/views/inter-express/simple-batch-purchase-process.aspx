        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="form-group" style="height: 20px; margin-bottom: 10px">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="txt_send_addr" class="form-control" readonly="readonly"
                            style="padding-top: 0px; padding-bottom: 0px; height: 25px" /></div>
                </div>
                    ...
                    <table class="table table-striped">
                        <tr style="height: 30px">
                            <td colspan="5" style="text-align: left">
                                <div class="col-md-5">
                                    <label class="control-label" style="padding-top: 2px; font-size: 16px; text-align: left">
                                        <font color="#FF0000">订单<%=i+1 %>：&nbsp;&nbsp;</font> 服务方式：<%=order.PostWay %>
                                    </label>
                                </div>
                                <div class="col-md-2" style="text-align: right">
                                    <input type="button" name="add_receiveAddr" class="btn btn-info reciver-address"
                                        value="添加收件地址" style="width: 120px; padding-top: 0px; padding-bottom: 0px; height: 25px" /></div>
                                <div class="col-md-5" style="text-align: left">
                                    <input type="text" class="form-control" name="receiveAddr" readonly="readonly" style="padding-top: 0px;
                        ...
                        <tr>
                            ...
                            <td style="width: 23%; text-align: left">
                                <input type="text" name="value" class="form-control Allvalue" style="width: 200px; padding-top: 0px;
                                    padding-bottom: 0px; height: 25px;" />
                            </td>
                        </tr>
                        <%} %>
