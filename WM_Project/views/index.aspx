        ...
        <div class="row">
            <div class="panel panel-primary">
                ...
                <div class="panel-footer">
                    <h6 style="color: red">
                        “皇家邮政经济包”最多只能下一个包裹，“皇家邮政优先包”最多可以下单三个包裹，华盟EMS专线 不限</h6>
                    <h6 style="color: red">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <p style="line-height: 25px">
                        2、Parcelforce Priority(“皇家邮政优先包”) 服务每单最多只能包括三个包裹；Parcelforce Economy(“皇家邮政经济包”)服务每单只能包括一个包裹</p>
                    <p style="line-height: 25px">
                        3、Parcelforce Priority(“皇家邮政优先包”)自带上限100镑保险，其他服务丢失保险金额上限50镑。</p>
                    <p style="line-height: 25px">
                        4、全部服务24/7即时出单，华盟快递网站上实时追踪您的包裹</p>
                    <p style="line-height: 25px">
                        5、为了您的包裹准时到达，请准确的计算您的包裹重量和尺寸</p>
                    <p style="line-height: 25px">
                        6、如果您选择Post NL Priority(“荷兰邮政优先包”) 或者China Post EMS(“华盟EMS专线”) 服务，我们为您提供多种英国境内物流方式帮助您将包裹发送到我们手上。</p>
                    <p style="line-height: 25px">
